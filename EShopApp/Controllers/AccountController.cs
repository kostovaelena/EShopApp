...
namespace EShopApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<ESApplicationUser> signInManager;
        public AccountController(UserManager<ESApplicationUser> userManager, SignInManager<ESApplicationUser> signInManager)
        {
