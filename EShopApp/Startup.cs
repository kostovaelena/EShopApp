...
using EShopApp.Repository.Implementation;
using EShopApp.Repository.Interface;
using EShopApp.Services;
using EShopApp.Services.Implementation;
...
namespace EShopApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<ESApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
